   ...
   DO WHILE ( aed_csv_read_row(unit, values) )
      DO ccol=2,nccols
         ...
         SELECT CASE (name)
            ...
            CASE ('Ing')                  ; bivalve_param(dcol)%Ing          = extract_integer(values(ccol))
            ...
            CASE ('fR20')                 ; bivalve_param(dcol)%fR20         = extract_integer(values(ccol))
            CASE ('War')                  ; bivalve_param(dcol)%War          = extract_double(values(ccol))
            CASE ('Wbr')                  ; bivalve_param(dcol)%Wbr          = extract_double(values(ccol))
            CASE ('fR')                   ; bivalve_param(dcol)%fR           = extract_integer(values(ccol))
            ...
            CASE ('fDO')                  ; bivalve_param(dcol)%fDO          = extract_integer(values(ccol))
